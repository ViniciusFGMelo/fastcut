...
export default ({ show, setShow, user, service }) => {
    ...
    const handleFinishClick = async () => {
        if(
            ...
            // let json = await Api.setAppointment(
            //     user.id,
            //     service,
            //     selectedYear,
            //     selectedMonth,
        ...
        >
            <ModalArea>
                <ModalBody>
                            ...
                            {listDays.map((item, key)=>(
                                <DateItem 
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: item.number == selectedDay ? '#50B9B8' :'#FFFFFF'
                                    }}
                                >
                                    <DateItemWeekDay
                                        style={{
                    ...
                    {selectedDay > 0 && listDays.length > 0 &&
                        <ModalItem>
                            <TimeList horizontal={true} showsHorizontalScrollIndicator={false}>
                                {listHours.map((item, key)=>(
                                    <TimeItem
                                        ...
                                        style={{
                                            backgroundColor: item === selectedHour ? '#50B9B8' : '#FFFFFF'
                                        }}
                                    >
                                        <TimeItemText
                                            style={{
